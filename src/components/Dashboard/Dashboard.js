...
function Dashboard({ Info }) {
  ...
  const HandleCreateForm = (e) => {
    ...
    setNewCreateBooks((prevBooks) => {
      return {
        ...prevBooks,
        [name]: value
      };
    });
    setCreateBooks((prevBooks) => {
      return {
        ...prevBooks,
        [name]: value
      };
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form>
                  ...
                  <Link type="submit" class="btn btn-primary" onClick={handleCreateBookSubmit} data-dismiss="modal" >Submit</Link>
                </form>
              </div>
              <div className="modal-footer">
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form>
                  <div class="form-group">
                    <label for="title">TITLE:</label>
                    <input type="text" class="form-control" id="title" value={newcreatebooks.title} onChange={HandleCreateForm} placeholder="Enter title" name="title" required />
                    {errors.title && <div className="text-danger">{errors.title}</div>} </div>
                  <div class="form-group">
                    <label for="author">AUTHOR NAME:</label>
                    <input type="text" class="form-control" id="author" value={newcreatebooks.author} onChange={HandleCreateForm} placeholder="Enter author" name="author" required />
                    {errors.author && <div className="text-danger">{errors.author}</div>} </div>
                  <div class="form-group ">
                    <label for="description">DESCRIPTION:</label>
                    <input type="text" class="form-control" id="description" value={newcreatebooks.description} onChange={HandleCreateForm} placeholder="Enter Description" name="description" required />
                    {errors.description && <div className="text-danger">{errors.description}</div>}  </div>
                  <Link type="submit" class="btn btn-primary" onClick={handleUpdateBookSubmit} data-dismiss="modal">Submit</Link>
                </form>
              </div>
              <div className="modal-footer">
                <button type="button" className="btn btn-danger" data-dismiss="modal" onClick={CloseDATA}>Close</button>
